...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        disco1.put(1, new Cancion("Cancion 2", "Artista 2"));
        disco1.put(1, new Cancion("Cancion 3", "Artista 3"));
        disco1.put(1, new Cancion("Cancion 4", "Artista 4"));
        disco1.put(1, new Cancion("Cancion 5", "Artista 5"));

        HashMap<Integer, Cancion> disco2 = new HashMap<>();
        disco2.put(1, new Cancion("Cancion 6", "Artista 1"));
        disco2.put(1, new Cancion("Cancion 7", "Artista 2"));
        disco2.put(1, new Cancion("Cancion 8", "Artista 3"));
        disco2.put(1, new Cancion("Cancion 4", "Artista 4"));
        disco2.put(1, new Cancion("Cancion 5", "Artista 5"));
